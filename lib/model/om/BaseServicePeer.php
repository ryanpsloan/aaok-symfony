...
abstract class BaseServicePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ServiceName', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'serviceName', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::SERVICE_NAME, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'service_name', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ServiceName' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'serviceName' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SERVICE_NAME => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'service_name' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ServicePeer::SERVICE_NAME);
    ...
    foreach (sfMixer::getCallables('BaseServicePeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseServicePeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseServicePeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			ServicePeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$selectCriteria->add(VolunteerPeer::SERVICE_ID, $obj->getId());
			$updateValues->add(VolunteerPeer::SERVICE_ID, null);
			...
			$selectCriteria = new Criteria(ServicePeer::DATABASE_NAME);
			$updateValues = new Criteria(ServicePeer::DATABASE_NAME);
			$selectCriteria->add(ClientPeer::SERVICE_ID, $obj->getId());
			$updateValues->add(ClientPeer::SERVICE_ID, null);
...
//
// NOTE: This static code cannot call methods on the ServicePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ServicePeer class:
//
// Propel::getDatabaseMap(ServicePeer::DATABASE_NAME)->addTableBuilder(ServicePeer::TABLE_NAME, ServicePeer::getMapBuilder());
//
