...
abstract class BaseUserPeer {
	...
	/** the column name for the AUTH_TOKEN field */
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Email', 'UserName', 'Password', 'Salt', 'AuthToken', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'email', 'userName', 'password', 'salt', 'authToken', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::EMAIL, self::USER_NAME, self::PASSWORD, self::SALT, self::AUTH_TOKEN, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'email', 'user_name', 'password', 'salt', 'auth_token', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Email' => 1, 'UserName' => 2, 'Password' => 3, 'Salt' => 4, 'AuthToken' => 5, 'CreatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'email' => 1, 'userName' => 2, 'password' => 3, 'salt' => 4, 'authToken' => 5, 'createdAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::EMAIL => 1, self::USER_NAME => 2, self::PASSWORD => 3, self::SALT => 4, self::AUTH_TOKEN => 5, self::CREATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'email' => 1, 'user_name' => 2, 'password' => 3, 'salt' => 4, 'auth_token' => 5, 'created_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::AUTH_TOKEN);
  ...
  {
    return array(array('email'), array('user_name'));
  }
	/**
