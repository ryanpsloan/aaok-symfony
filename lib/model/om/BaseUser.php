...
abstract class BaseUser extends BaseObject  implements Persistent {
  ...
  const PEER = 'UserPeer';
	...
	/**
	 * The value for the auth_token field.
	 * @var        string
	 */
	...
	/**
	 * Get the [auth_token] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [auth_token] column.
	 * 
	 * @param      string $v new value
	 * @return     User The current object (for fluent API support)
	 */
	public function setAuthToken($v)
	{
		...
		if ($this->auth_token !== $v) {
			$this->auth_token = $v;
			$this->modifiedColumns[] = UserPeer::AUTH_TOKEN;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->auth_token = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setAuthToken($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPeer::AUTH_TOKEN)) $criteria->add(UserPeer::AUTH_TOKEN, $this->auth_token);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setAuthToken($this->auth_token);
