...
abstract class BaseStatePeer {
	...
	/** the column name for the STATE_ABBREVIATION field */
	const STATE_ABBREVIATION = 'state.STATE_ABBREVIATION';

	/**
	 * An identiy map to hold any loaded instances of State objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'StateName', 'StateAbbreviation', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'stateName', 'stateAbbreviation', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::STATE_NAME, self::STATE_ABBREVIATION, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'state_name', 'state_abbreviation', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'StateName' => 1, 'StateAbbreviation' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'stateName' => 1, 'stateAbbreviation' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::STATE_NAME => 1, self::STATE_ABBREVIATION => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'state_name' => 1, 'state_abbreviation' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new StateMapBuilder();
		}
	 ...
	 * @param      string $column The column name for current table. (i.e. StatePeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(StatePeer::STATE_ABBREVIATION);
	 ...
	 *
	 * @param      mixed $value A State object or a primary key value.
	 */
	 ...
	 * @return     State Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
  ...
  {
    return array(array('state_name'), array('state_abbreviation'));
  }
	/**
	...
	/**
	 * Method perform an INSERT on the database, given a State or Criteria object.
	 *
	 * @param      mixed $values Criteria or State object containing data that is used to create the INSERT statement.
    ...
    foreach (sfMixer::getCallables('BaseStatePeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from State object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a State or Criteria object.
	 *
	 * @param      mixed $values Criteria or State object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the state table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			StatePeer::doOnDeleteSetNull(new Criteria(StatePeer::DATABASE_NAME), $con);
	...
	/**
	 * Method perform a DELETE on the database, given a State or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof State) {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			StatePeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$selectCriteria = new Criteria(StatePeer::DATABASE_NAME);
			$updateValues = new Criteria(StatePeer::DATABASE_NAME);
			$selectCriteria->add(VolunteerPeer::STATE_ID, $obj->getId());
			$updateValues->add(VolunteerPeer::STATE_ID, null);
			...
			$selectCriteria = new Criteria(StatePeer::DATABASE_NAME);
			$updateValues = new Criteria(StatePeer::DATABASE_NAME);
			$selectCriteria->add(ClientPeer::STATE_ID, $obj->getId());
			$updateValues->add(ClientPeer::STATE_ID, null);
	...
	/**
	 * Validates all modified columns of given State object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      State $obj The object to validate.
...
//
// NOTE: This static code cannot call methods on the StatePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the StatePeer class:
//
// Propel::getDatabaseMap(StatePeer::DATABASE_NAME)->addTableBuilder(StatePeer::TABLE_NAME, StatePeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseStatePeer::DATABASE_NAME)->addTableBuilder(BaseStatePeer::TABLE_NAME, BaseStatePeer::getMapBuilder());
